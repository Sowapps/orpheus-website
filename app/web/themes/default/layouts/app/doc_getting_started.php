...
<div class="alert alert-info" role="alert">
	Orpheus Blossoming will come soon. For now, this project is WIP, expect some interesting changes.
</div>
...
<h4>Run the setup</h4>
<p>
	In the parent folder of your new project, run the setup <code>php orpheus.phar install my-project-name</code>.<br>
...
<div class="row">
	<div class="col-sm-4">
		...
		<p><a href="<?php echo u(ROUTE_DOWNLOAD_LATEST); ?>" class="btn btn-lg btn-success" target="_blank">Download Latest</a></p>
	</div>
	<div class="col-sm-4">
		<h3 id="browser-releases">The Releases</h3>
		<p>All releases, get the version you want by browsing our repos on GitHub.</p>
		<p><a href="<?php echo u(ROUTE_DOWNLOAD_RELEASES); ?>" class="btn btn-lg btn-primary" target="_blank">Browse Releases</a></p>
	</div>
	<div class="col-sm-4">
		<h3 id="our-github">The GitHub</h3>
		<p>Directly browse the sources, you could clone it from GitHub.</p>
		<p><a href="<?php echo AppConfig::instance()->get('github_url') ?? 'https://github.com/Sowapps/orpheus'; ?>" class="btn btn-lg btn-info text-white" target="_blank">See our GitHub</a></p>
	</div>
</div>
<br>
...
<p>
	Orpheus separates different package features in namespaces and composer is helping you to maintain your application up-to-date by taking care of your
	dependencies.<br>
...
<div class="row">
	...
	<div class="col-sm-4">
		...
		<p>To get it online, create a route in the file config/routes.yaml using instructions and examples we provided.</p>
	</div>
</div>
<blockquote>As you could see, it's so easy !</blockquote>

		...
		<li class="nav-item dropdown">
			...
			<ul class="dropdown-menu dropdown-menu-end">
				...
				if( $authenticatedUser !== $user ) {
					?>
					<li>
						<a class="dropdown-item" href="<?php echo u('impersonating_terminate'); ?>">
							<i class="fa-solid fa-person-walking-arrow-loop-left me-1"></i>
							<?php echo t('impersonating_terminate'); ?>
						</a>
					</li>
					<?php
				}
		...
		<nav class="sb-sidenav accordion <?php echo $invertedStyle ? 'sb-sidenav-dark' : 'sb-sidenav-light'; ?>" id="sidenavAccordion">
			<div class="sb-sidenav-menu">
				<div class="nav">
					...
					$menus = [
						'user'      => true,
						'admin'     => $user->hasRoleAccessLevel('administrator'),
						'developer' => $user->hasRoleAccessLevel('developer'),
					];
			...
			<div class="sb-sidenav-footer">
				...
				if( $authenticatedUser ) {
					if( $authenticatedUser !== $user ) {
						?>
						<div class="small"><?php echo t('user'); ?></div>
						<?php
						echo $user;
					}
					?>
